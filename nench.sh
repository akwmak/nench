...
#################################################
    ...
    printf '    Speedtest, (Softlayer, Seattle, WA):         '
    ...
    download_benchmark -4 http://speedtest.fremont.linode.com/100MB-fremont.bin | \
        Bps_to_MiBps
#################################################
    printf '    Speedtest, (Softlayer, HongKong, CN):         '
    download_benchmark -4 http://speedtest.hkg02.softlayer.com/downloads/test100.zip | \
        Bps_to_MiBps
        
    printf '    Speedtest, (Softlayer, Singapore, SG):         '
    download_benchmark -4 http://speedtest.sng01.softlayer.com/downloads/test100.zip | \
        Bps_to_MiBps
